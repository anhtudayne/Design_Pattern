...
> **classdiagram.md** (đầy đủ) + **plans/03** Proxy (Caching) pattern.
...
classDiagram
  ...
  %% ═══════════════════════════════════════════════════════════
  %% PATTERN — Proxy / Caching (plans/03)
  %% ═══════════════════════════════════════════════════════════
  ...
  MovieServiceImpl ..> Movie : loads/saves
  CachingMovieServiceProxy ..> Movie : caches list via Redis
