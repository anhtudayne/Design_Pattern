# UML — Composite + Domain

> **classdiagram.md** (đầy đủ) + **plans/05** Composite pattern.
...
classDiagram
  ...
  MovieStatsLeaf ..> Movie : counts
  UserStatsLeaf ..> User : counts
  ShowtimeStatsLeaf ..> Showtime : counts
  FnbStatsLeaf ..> FnbItem : counts
  RevenueStatsLeaf ..> Payment : sums revenue
  DashboardController --> DashboardStatsComposite
  Admin ..> DashboardController : viewDashboard
```
