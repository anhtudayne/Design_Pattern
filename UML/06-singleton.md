# UML — Singleton + Domain

> **classdiagram.md** (đầy đủ) + **plans/06** Singleton (Spring IoC) pattern.
...
classDiagram
  ...
  %% ═══════════════════════════════════════════════════════════
  %% PATTERN — Singleton via Spring IoC (plans/06)
  %% ═══════════════════════════════════════════════════════════
  ...
  MomoServiceImpl ..> Payment : creates/updates payment
```
