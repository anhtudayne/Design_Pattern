# UML — Prototype + Domain

> **classdiagram.md** (đầy đủ) + **plans/07** Prototype pattern.
...
classDiagram
  ...
  EmailServiceImpl ..> Booking : loads for ticket email
  EmailServiceImpl ..> Ticket : reads ticket info
  EmailServiceImpl ..> Customer : reads name/email
  TicketEmailPrototype ..> Booking : builds message from booking data
```
